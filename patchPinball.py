...
# ADDRESSES
DECREMENT_BALL_ADDRESS = 0x00011CF2     # 0x010128F2 using exe module base address offset
END_GAME_CODE_ADDRESS = 0x00013B9B      # 0x0101479B using exe module base address offset
TOGGLE_DEMO_MODE_ADDRESS = 0x00014C02   # 0x01015802 using exe module base address offset
